...
class EditInsuranceScreen extends StatefulWidget {
  ...
  const EditInsuranceScreen({super.key, required this.user, required this.insurance});
...
class _EditInsuranceScreenState extends State<EditInsuranceScreen> {
  ...
  void initState() {
    super.initState();
    _companyEditingController.text = widget.insurance.insuranceName.toString();
    _policyEditingController.text = widget.insurance.policyNumber.toString();
    _startdateEditingController.text = widget.insurance.startDate.toString();
    _enddateEditingController.text = widget.insurance.endDate.toString();
  }
...
Future<void>_showSelectionDialog() async{
  ...
  void updateInsurance() {
    String newName = _companyEditingController.text;
    String newNumber = _policyEditingController.text;
    String newStartDate = _startdateEditingController.text;
    String newEndDate = _enddateEditingController.text;
    String base64Image = base64Encode(_image!.readAsBytesSync());

  http.post(Uri.parse("${MyConfig().SERVER}/carBuddy/php/update_insurance.php"),
    body: {
      "userid":widget.user.id.toString(),
      "carid": widget.insurance.carId.toString(),
      "newName":newName,
      "newNumber":newNumber,
...
Navigator.pop(context, true);
  setState(() {
    widget.insurance.insuranceName = newName;
    widget.insurance.policyNumber = newNumber;  
    widget.insurance.startDate = newStartDate;  
    widget.insurance.endDate = newEndDate;  
  });
} else {
  ScaffoldMessenger.of(context)
